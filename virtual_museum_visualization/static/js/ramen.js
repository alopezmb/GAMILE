    ...
    (function (Items) {
        ...
        var Item = (function (_super) {
            ...
            Item.prototype.showError = function (vec3) {
                ...
                var isDoor = this.metadata.itemName === "Open Door";
                // Doors will not glow on hover
                if (!isDoor){
                    if (!this.error) {
                        this.error = true;
            ...
            ;
            Item.prototype.getOrientation = function () {
            ...
            Item.prototype.getRoom = function (model) {
                //Mesh position
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var Room = (function () {
            ...
            Room.prototype.updateWallsTexture = function () {
                var walls = [];
                var prevEdge = null;
                var firstEdge = null;
                for (var i = 0; i < this.corners.length; i++) {
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var Floorplan = (function () {
             ...
             */
            Floorplan.prototype.newWall = function (start, end, floorplanner) {
            ...
            Floorplan.prototype.getMinCorner = function () {
                var xMin = Infinity;
                var zMin = Infinity;
                this.corners.forEach(function (corner) {
                    if (corner.x < xMin)
                ...
                var minCorner = new THREE.Vector3(xMin, 0, zMin);
                return minCorner;
            };
        ...
        var Scene = (function () {
            ...
            Scene.prototype.addItem = function (itemType, fileName, metadata, position, rotation, scale, fixed) {
                ...
                var loaderCallback = function (geometry, materials) {
                    ...
                    for (var z = 0; z < n; z++) {
                        var item = new (BP3D.Items.Factory.getClass(itemType))(scope.model, metadata, geometry, new THREE.MeshFaceMaterial(materials), pos[z], rot[z], sca[z]);
            ...
            Scene.prototype.addItem2 = function (itemType, fileName, metadata, position, rotation, scale, fixed) {
                itemType = itemType || 1;
                var scope = this;
                var loaderCallback = function (geometry, materials) {
            ...
            Scene.prototype.calculateScale = function (itemName) {
...
(function (BP3D) {
    ...
    (function (Floorplanner) {
        ...
        // grid parameters
        var gridSpacing = 25; // pixels
        var gridWidth = 1;
        // const gridColor = "#f1f1f1";
        var gridColor = "#6E6E6E";
        // room config
        ...
        var FloorplannerView = (function () {
            ...
            FloorplannerView.prototype.drawEdgeLabel = function (edge) {
                ...
                var lengthM = (length / 100).toFixed(2);
                // this.context.strokeText(Core.Dimensioning.cmToMeasure(length),
                this.context.strokeText(lengthM, this.viewmodel.convertX(pos.x), this.viewmodel.convertY(pos.y));
                this.context.fillText(lengthM, 
                // this.context.fillText(Core.Dimensioning.cmToMeasure(length),
                this.viewmodel.convertX(pos.x), this.viewmodel.convertY(pos.y));
            };
            /** */
    ...
    (function (Floorplanner_1) {
        ...
        var Floorplanner = (function () {
            ...
            Floorplanner.prototype.mousemove = function (event) {
                ...
                //     this.updateTarget();
                // }
                if (this.mode == Floorplanner_1.floorplannerModes.DRAW) {
                    this.updateTarget();
                }
            ...
            Floorplanner.prototype.moveWallRefresh = function () {
            ...
            /** */
            Floorplanner.prototype.reset = function (zoom) {
            ...
            Floorplanner.prototype.zoom = function (zoomValue) {
                if (zoomValue == "in") {
            ...
            Floorplanner.prototype.scale = function (val) {
                var div = val / 50;
                var rest = val % 50;
                div = Math.floor(div);
                if (rest > 25) {
        ...
        Three.Controller = function (three, model, camera, element, controls, hud) {
            ...
            function checkWallsAndFloors () {
                ...
                if (state == states.UNSELECTED && mouseoverObject == null) {
                    ...
                    var wallIntersects = scope.getIntersections(mouse, wallEdgePlanes, false, false);
                    console.log('walls intersected: ', wallIntersects);
            ...
            function updateIntersections() {
                ...
                var walls = model.floorplan.wallEdges();
                /*
                la clave podria estar aqui en wall intersects con interior start and end;
                const wall = walls[0];
                console.log(wall.interiorStart());
                console.log(wall.interiorEnd());
                //console.log('walls');
                //console.log(walls);
                //var wallIntersects = scope.getIntersections(mouse, walls, false, true);
                //console.log('wall intersects');
            ...
            function updateMouseover() {
                ...
                if (intersectedObject != null) {
                    if (mouseoverObject != null) {
                        ...
                        mouseoverObject = intersectedObject;
                        mouseoverObject.mouseOver();
                        var isDoor = intersectedObject.metadata.itemName === "Open Door";
                        appropriateCursor = isDoor ? "auto" : "pointer";
                        three.setCursorStyle(appropriateCursor);
                        scope.needsUpdate = true;
                    }
                }
    ...
    (function (Three) {
        Three.Edge = function (scene, edge, controls) {
            ...
            function updateVisibility() {
                ...
                // show or hide plans
                planes.forEach(function (plane) {
                    plane.visible = scope.visible; // All walls visible set to true
                });
...
(function (BP3D) {
    var Three;
    (function (Three) {
        Three.Controls = function (object, model, domElement) {
            this.object = object;
            this.walls = model.floorplan
            this.items = model.scene;
            ...
            this.accumulatedRotation = 0; // rotation with respect to -z axis (-z direction is 0 rad)
            ...
            this.update = function () {
                ...
                offset.z = 100 * Math.sin(phi) * Math.cos(theta);
            ...
            this.isValidPosition = function(vec3,mesh){
            ...
            /**
                Rotate camera when user drags camera.
            */
            function onMouseMove(event) {
                scope.isRotatingCamera = true;
                if (scope.enabled === false)
                    return;
                event.preventDefault();
                var element = scope.domElement === document ? scope.domElement.body : scope.domElement;
                if (state === STATE.ROTATE) {
				    ...
				    var _PI_2 = Math.PI / 2;
				    var position = scope.object.position;
				    const _euler = new THREE.Euler( position.x, position.y, position.z, 'XYZ' );
				    _euler.y -= movementX * 0;
				    _euler.x -= movementX * 1;

                    rotateStart.set(position.x, position.y);
                    rotateEnd.set(_euler.x, _euler.y);
                    rotateDelta.subVectors(rotateEnd, rotateStart);
                    // rotating across whole screen goes 360 degrees around
                    var rotation = 2 * Math.PI * rotateDelta.x / element.clientHeight * scope.rotateSpeed;
                    scope.accumulatedRotation += rotation;
                    scope.rotateLeft(rotation);
            ...
            function onKeyDown(event) {
                ...
                const old_pos = scope.object.position;

                switch (event.keyCode) {
                    case scope.keys.UP:
                        scope.pan(new THREE.Vector2(0, scope.keyPanSpeed));
                        const new_pos = scope.object.position;
                        break;
    ...
    (function (Three) {
        ...
        Three.HUD = function (three) {
            ...
            function makeObject(item) {
                ...
                var line = new THREE.Line(makeLineGeometry(item), makeLineMaterial(scope.rotating), 
                //THREE.LinePieces);
                2);
...
(function (BP3D) {
    ...
    (function (Three) {
        ...
        Three.Human = function (scene, model, steps, type, allRooms) {
            // var meshes = [];
            var mixers = [];
            var items = [];
            var doors = [];
            ...
            function init() {
                ...
                jsonLoader.load("/static/models/js/walkmorphcolor.json", addModelToScene);
            ...
            function addModelToScene(geometry, materials) {
                ...
                if (!scene.realTime) {
                    //Adding Mesh
                    for (var j = 0; j < steps[0].length; j++) {
                        if (steps[0][j].agent != undefined) {
                            ...
                            var position = steps[0][j].position;
                            if (type == 0) {
                            ...
                            if (steps[0][j].sentiment != undefined) {
                                var sentiment = steps[0][j].sentiment;
            ...
            this.addIndividualModelToScene = function (agent, x, y, sentiment, rotation) {
                ...
                var material1 = new THREE.MeshLambertMaterial();
                material1.morphTargets = true;
                var mesh = new THREE.SkinnedMesh(geometry1, material1);
                mesh.scale.set(55, 65, 55);
                scene.add(mesh);
                ...
                if (Math.abs(meshX - x) > speed2 - 1 || Math.abs(meshZ - z) > speed2 - 1) {
                    ...
                    if (type == 0) {
                        ...
                        if (!rotateMesh(mesh, rotationAngle)) {
                            ...
                            var timeElapsed = thisTime - startTime;
            ...
            this.moveMeshes = function () {
                if (type == 0 || type == 1) {
                    ...
                    for (var i = 0; i < meshesMoving.length; i++) {
            ...
            this.calculateSpeed = function (x1, y1, x2, y2, time) {
                var distance = BP3D.Core.Utils.distance(x1, y1, x2, y2);
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Main = function (model, element, canvasElement, opts) {
            ...
            // var customUniforms;
            function init() {
                initialPositionVector = new THREE.Vector3(1450,150,2300);
                ...
                scope.controls = new Three.Controls(camera, model, domElement);
            ...
            function render() {
                ...
                if (model.play) {
                    ...
                    if (scene.video && scene.video.readyState === scene.video.HAVE_ENOUGH_DATA) {
                        ...
                        if (scene.textureVideo)
                            scene.textureVideo.needsUpdate = true;
                    }
                }
                else {
                    if (paused == 1) {
            ...
            /*
            * Sets camera at the center of the museum map.
            */
            this.centerCamera = function () {
                ...
                var offset = pan.clone().add(new THREE.Vector3(0, 0, distance));
                camera.position.copy(offset);
                scope.controls.update();

            };
            /*
            * Allows setting the desired starting z value
            */
            this.adjustZComponent = function (desiredZ, panUnit){
                console.log('Adjusting Z component to: ', desiredZ);
                const currentZ = camera.position.z;
                const differenceZ = desiredZ - currentZ;
                const panToUse = Math.abs(differenceZ/panUnit);
                scope.controls.panXY(0, - panToUse);
                scope.controls.update();
                console.log('Achieved z: ', camera.position.z);
            }

            this.getCurrentCameraPosition = function (){
                const desiredZ = initialPositionVector.z;
                console.log('desired z: ', desiredZ);
                let zToAdjust = camera.position.z;
                let diffZ = desiredZ - zToAdjust;
                const unit = 0.08692834467433386;
                const panToUse = Math.abs(diffZ/unit);
                console.log('pan to  use:', panToUse);
                scope.controls.panXY(0, - panToUse);
                scope.controls.update();
                console.log(camera.position);
            }
            this.getWallInfo = function(wall_id){
                console.log('wall info:');
                var wall = floorplan.floorplan.walls.find(obj => {
                    return obj.id === wall_id
                 })
                console.log(wall);
            }
            ...
            this.createLoadMovement = function () {
                scene.loadMovement = new Three.LoadMovement(scene, model);
            };
            init();
        };
    })(Three = BP3D.Three || (BP3D.Three = {}));
...
console.log("RAMEN iML " + BP3D.Core.Version.getInformalVersion()
...
(function (BP3D) {
    var Three;
    (function (Three) {
        Three.Audio = function (camera, scene) {
            var listener;
            function init() {
...
(function (BP3D) {
    var Three;
    (function (Three) {
        Three.Fire = function (scene, model) {
            var customMaterial;
            var ballGeometry;
            function init() {
...
(function (BP3D) {
    var Three;
    (function (Three) {
        Three.LoadMovement = function (scene, model) {
            var scene = scene;
            var model = model;
            var movementJSON;
            var allRooms;
            ...
            function init() {
                ...
                if (scene.realTime) {
                    //Creating agents
                    human = new Three.Human(scene, model, [], type, scene.rooms);
                }
                else {
                    ...
                    type = jsonMove.type;
                    //Creating agents
                    human = new Three.Human(scene, model, steps, type, scene.rooms);
                }
            ...
            this.moveAll = function (step) {
                ...
                if (scene.flag == 1) {
                    ...
                    if (scene.realTime) {
                        ...
                        stepArr = scene.realSteps === undefined ? undefined : scene.realSteps['steps'];
                        type = scene.realSteps === undefined ? type : scene.realSteps['type'];
                        //console.log(stepArr);
                    }
                    else {
                        stepArr = steps[step];
                        ...
                        for (var i = 0; i < stepArr.length; i++) {
                            ...
                            if (stepArr[i].light != undefined) {
                                ...
                                if (stepArr[i].room != undefined) {
                                    var room = whichRoom(stepArr[i].room);
                            ...
                            if (stepArr[i].video != undefined) {
                                ...
                                var video = new Three.Video(scene, model, human.getRoom(roomCoordinates.x, roomCoordinates.y));
                            }
                            //FIRE
                            if (stepArr[i].fire != undefined) {
                                if (stepArr[i].fire == true) {
                                    if (fire == undefined) {
                                        fire = new Three.Fire(scene, model);
                                    }
                ...
                if (scene.meshes.length > 0){
                     current_pos_x = scene.meshes[scene.agentNumber].position.x;
                     current_pos_y = scene.meshes[scene.agentNumber].position.z;
                     //console.log(`new agent's position: (${current_pos_x},${current_pos_y})`);
            ...
            function addNewAgent(stepArr, i) {
                ...
                scene.agentNumber = stepArr[i].agent;
            }
            ...
            function moveAgentByRoomOrCoordinates(stepArr, i, step) {
                if (stepArr[i].moveTo != undefined && stepArr[i].toStep != undefined) {
                    var time = stepArr[i].toStep * scene.stepTime;
            ...
            function moveAgentByDirection(stepArr, i) {
                ...
                if (stepArr[i].direction != undefined && stepArr[i].speed != undefined) {
                    ...
                    //xTo = stepArr[i].moveTo.x;
                    //yTo = stepArr[i].moveTo.y;
                    ...
                    //console.log(`target position: (${xTo},${yTo})`);
                    scene.stop = mustStop(direction);
                }
                //Setting sentiment
                if (stepArr[i].sentiment != undefined) {
                    human.changeColorEmotion2(stepArr[i].sentiment, stepArr[i].agent);
                ...
                if (scene.stop) {
                    ...
                    original_pos_x = current_pos_x;
                    original_pos_y = current_pos_y;
            ...
            function mustStop(direction){

                console.log(`stop old agent's position: (${original_pos_x},${original_pos_y})`);
                console.log(`stop new agent's position: (${current_pos_x},${current_pos_y})`);
                ...
                switch(direction) {
                    ...
                    case 'N':
                        stop = original_pos_y - scene.pos_margin > current_pos_y;
                        break;
                    ...
                    case 'E':
                        stop = original_pos_x + scene.pos_margin < current_pos_x;
                        break;
            ...
            function getRoomLight(room) {
                ...
                return texture == "/static/rooms/textures/hardwood.png";
            }
            function setRoomLight(room, on) {
                ...
                for (var i = 0; i < walls.length; i++) {
                    ...
                    if (walls[i].to == false) {
                        //Turn on
                        if (on == "high") {
                            walls[i].backEdge.setTexture("/static/rooms/textures/wallmap.png", true, 1);
                            model.floorplan.getRooms()[room].setTexture("/static/rooms/textures/hardwood.png", true, 300);
                        }
                        else if (on == "medium") {
                            walls[i].backEdge.setTexture("/static/rooms/textures/walllightmap_medium.png", true, 1);
                            model.floorplan.getRooms()[room].setTexture("/static/rooms/textures/hardwood_medium.png", true, 300);
                        }
                        else if (on == "low") {
                            walls[i].backEdge.setTexture("/static/rooms/textures/walllightmap_dark.png", true, 1);
                            model.floorplan.getRooms()[room].setTexture("/static/rooms/textures/hardwood_dark.png", true, 300);
                        }
                    }
                    else {
                        //Turn on
                        if (on == "high") {
                            walls[i].frontEdge.setTexture("/static/rooms/textures/wallmap.png", true, 1);
                            model.floorplan.getRooms()[room].setTexture("/static/rooms/textures/hardwood.png", true, 300);
                        }
                        else if (on == "medium") {
                            walls[i].frontEdge.setTexture("/static/rooms/textures/walllightmap_medium.png", true, 1);
                            model.floorplan.getRooms()[room].setTexture("/static/rooms/textures/hardwood_medium.png", true, 300);
                        }
                        else if (on == "low") {
                            walls[i].frontEdge.setTexture("/static/rooms/textures/walllightmap_dark.png", true, 1);
                            model.floorplan.getRooms()[room].setTexture("/static/rooms/textures/hardwood_dark.png", true, 300);
                        }
                    }
                }
...
(function (BP3D) {
    var Three;
    (function (Three) {
        Three.Video = function (scene, model, room) {
            var plane;
            var materialVideo;
            var mesh;
            function init() {
